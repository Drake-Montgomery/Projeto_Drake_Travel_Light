...
namespace Drake_Travel_Light.Controllers
{
    public class VoosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id_Voo,Destino,Assento,Data_ida,Data_volta")] Voo voo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id_Voo,Destino,Assento,Data_ida,Data_volta")] Voo voo)
        {
            if (id != voo.Id_Voo)
            {
                return NotFound();
        ...
        {
            return _context.Voo.Any(e => e.Id_Voo == id);
        }
    }
}
